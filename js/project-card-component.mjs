export class DwcProjectCard extends HTMLElement {
  constructor() {
    ...
    img1.src = this.getAttribute("img1-src") || "./icons/Line.svg";
    img1.alt = this.getAttribute("img1-alt") || "";

    const img2 = document.createElement("img");
    img2.src = this.getAttribute("img2-src") || "./images/Card.png";
    img2.alt = this.getAttribute("img2-alt") || "";
    img2.height = this.getAttribute("img2-height") || "300";

    const img3 = document.createElement("img");
    img3.src = this.getAttribute("img3-src") || "./icons/Arrow.svg";
...
customElements.define("dwc-project-card", DwcProjectCard);
